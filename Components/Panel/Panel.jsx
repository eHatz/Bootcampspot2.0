...
class Panel extends Component {
	...
	render() {
		const { panelId, img, name, background, pageLink,proptocheck} = this.props;
		...
		return (
			<a href={'#' + pageLink}>
				<Col sm={2} className="remove-all-margin-padding">
					...
					<div id={panelId} className="Panel_panelDiv animated pulse" style={{backgroundColor: background}}>
